...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, Image, Modal, Dimensions, TextInput } from 'react-native';
        ...
        <>
          ...
          {isLoading ? (
            ...
            <FlatList
              ...
              keyExtractor={(item) => item.id}
              numColumns={3} // Changed from 2 to 3 for more square layout
...
const createStyles = (theme: any) => StyleSheet.create({
  ...
  videoItem: {
    width: '31%', // Make them more square (3 columns with gaps)
  ...
  videoThumbnail: {
    width: '100%',
    aspectRatio: 16/9, // Maintain proper video thumbnail aspect ratio
    borderRadius: 8,
    marginBottom: 8,
  },
  videoInfo: {
  ...
  videoTitle: {
    fontSize: 12, // Slightly smaller for square layout
    fontWeight: 'bold',
    color: theme.colors.text,
    marginBottom: 4,
    lineHeight: 14,
