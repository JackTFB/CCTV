  ...
  return (
    <View style={styles.container}>
      <View style={styles.banner}>
        ...
        <Text style={styles.bannerText}>{profile.username}</Text>
      </View>
      ...
      <View style={styles.profileSettings}>
        ...
        {profile.profileImageUri && (
          ...
          >
            <Text style={styles.resetButtonText}>🔄 Reset to Default Image</Text>
          </Pressable>
        )}

        <View style={styles.infoContainer}>
          <Text style={styles.infoTitle}>ℹ️ Image Information</Text>
...
const createStyles = (theme: any) => StyleSheet.create({
  ...
  profileSettingsButtonHover: {
    backgroundColor: theme.colors.buttonHover || theme.colors.accent,
